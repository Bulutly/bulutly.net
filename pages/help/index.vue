      ...
      <div class="mx-auto text-center mb-8 lg:mb-16">
        ...
        <div class="relative">
          ...
          <input
            ...
            class="block p-4 pl-12 w-full text-gray-900 bg-gray-50 rounded-sm border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
