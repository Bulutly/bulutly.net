<template>
    <section class="bg-white dark:bg-gray-900 rounded-lg px-5 mt-5">
        ...
        <div class="flex items-start p-4 bg-white border border-gray-100 top-6 dark:bg-gray-700 dark:border-gray-600">
            <div class="flex flex-col items-center mb-3 mr-4 md:items-center md:flex-row md:mb-0">
                <a href="https://trader4.net/"
                   class="flex items-center mb-2 border-gray-200 md:pr-4 md:mr-4 md:border-r md:mb-0 dark:border-gray-600">
                    <img src="https://flowbite.com/docs/images/logo.svg" class="h-6 mr-2" alt="Trader4 Logo">
                    <span class="self-center text-lg font-semibold whitespace-nowrap dark:text-white">T4 Enterprise</span>
                </a>
                <p class="flex items-center text-sm font-normal text-gray-500 dark:text-gray-400">Are you looking for an
                    enterprise services? We are here, We will be happy to hear your needs.</p>
            </div>
            <div class="flex items-end flex-shrink-0">
                <a href="#"
                   class="px-5 py-2 mr-2 text-xs font-medium text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Contact
                    Us</a>
            </div>
        </div>
            ...
            <div id="detailed-pricing" class="overflow-x-auto mt-8 w-full">
                <div class="overflow-hidden min-w-max">
                    ...
                    <div
                        ...
                        <div>
                            Ticket, Email (24 Hours)
                        </div>
                        <div>
                            Ticket, Email, Phone (8 Hours)
                        </div>
                        <div>
                            Ticket, Email, Phone (>One Hour)
                        </div>
                    </div>
                    <div
                            class="grid grid-cols-4 gap-x-16 py-5 px-4 text-sm text-gray-700 border-b border-gray-200 dark:border-gray-700">
                        ...
                        <div>
                            Forex, Stocks, Crypto, <br/> Commodities, Indices
                        </div>
                        <div>
                            Forex, Stocks, Crypto, <br/> Commodities, Indices, <br/> Futures, Bond, Options
                        </div>
                    </div>
                    <div
                            class="grid grid-cols-4 gap-x-16 p-4 text-sm font-medium text-gray-900 bg-gray-100 border-t border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700 dark:text-white">
                    ...
                    <div
                            class="grid grid-cols-4 gap-x-16 py-5 px-4 text-sm text-gray-700 border-b border-gray-200 dark:border-gray-700">
                        <div class="text-gray-500 dark:text-gray-400">Realtime Connection</div>
                        <div>
                            <svg
                                class="w-6 h-6 text-green-500"
                                fill="currentColor"
                    ...
                    <div
                            class="grid grid-cols-4 gap-x-16 py-5 px-4 text-sm text-gray-700 border-b border-gray-200 dark:border-gray-700">
                        <div class="text-gray-500 dark:text-gray-400">Optimize Parameters</div>
                        <div>
                            <svg
                                    class="w-6 h-6 text-red-500"
                                    fill="currentColor"
                    ...
                    <div
                        ...
                        <div>
                            <a
                                    href="#"
                                    class="text-white block w-full bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:ring-blue-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:focus:ring-blue-900"
                            >Buy now</a
                            >
                        </div>
                        <div>
