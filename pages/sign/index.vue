<template>
    <div>
        <!-- Block start -->
        <section class="dark:bg-gray-900 flex flex-col justify-center items-center min-h-screen">
            <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-20 lg:py-16 lg:grid-cols-12">
                <div class="w-full place-self-center lg:col-span-6 order-2 md:order-1">
                    <div class="p-6 mx-auto bg-white rounded-lg shadow dark:bg-gray-800 sm:max-w-xl sm:p-8">
                        <NuxtLink to="/"
                            ...
                            <img src="https://docs.trader4.net/images/logo.svg" class="dark:bg-white dark:rounded-lg"
                                alt="logo" width="150">
                        </NuxtLink>
                        ...
                        <div class="mt-4 space-y-6 sm:mt-6">
                            <div>
                                ...
                                <BaseTextField v-model="identifier" type="email" name="email" id="email" />
                            </div>
                            ...
                            <BaseButton :is-disabled="isDisabled" @click="loginUser">Sign in to your account
                            </BaseButton>
                        </div>
                    </div>
                </div>
                <div class="mr-auto place-self-center lg:col-span-6 order-1 md:order-2">
                    <img class="mx-auto"
