<template>
  <div>
    <!-- Block start -->
    <section class="dark:bg-gray-900 rounded-xl mt-3">
      <div class="max-w-screen-xl px-4 py-8 mx-auto lg:grid lg:gap-20 lg:py-16 lg:grid-cols-12">
        <div class="flex-col justify-between hidden col-span-6 mr-auto lg:flex xl:mb-0">
          <div>
            <a href="#"
              ...
              <img width="100" class="mr-2" src="https://docs.trader4.net/images/logo.svg" alt="logo" />
            </a>
            <div class="flex">
        ...
        <div class="mb-6 text-center lg:hidden">
          <a href="#" class="inline-flex items-center text-2xl font-semibold text-gray-900 lg:hidden dark:text-white">
            <img width="120" src="https://docs.trader4.net/images/logo.svg" alt="logo" />
          </a>
        </div>
            ...
            <Form class="space-y-4 lg:space-y-6" @submit="loginUser" :validation-schema="schema">
              <div>
                <label for="email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Email
                  Address</label>
                <Field v-model="identifier" type="email" name="email" id="email"
...
const schema = Yup.object({
  email: Yup.string().email().required().label("ID"),
});
</script>