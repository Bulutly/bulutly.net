  ...
  <div>
    <section class="bg-gray-50 dark:bg-gray-900">
      <div class="grid py-10 mx-auto lg:py-16 grid-cols-12 items-center">
        <div
          class="lg:col-span-6 col-span-full md:max-w-lg w-full mx-auto rounded-sm"
        >
          <div
            ...
            >
              <div>
                ...
                <Field
                  ...
                  autofocus
                  class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-sm focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                />
