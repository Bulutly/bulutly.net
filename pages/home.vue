    ...
    <section class="tag-box py-4 relative mx-auto">
      ...
      >
        <button
          v-if="showBackButton"
          @click="moveBack"
          class="absolute md:block hidden z-10 -left-1 top-3 rounded-xl py-2 px-3 shadow-lg bg-gray-50 dark:bg-gray-700 transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-105"
        >
          ...
          <template v-for="(tag, index) in 4" :key="index">
            ...
            >
              <a href="#" class="relative">
                <img
                  class="p-4 w-full rounded-3xl h-44 object-cover"
                ...
                >
                  <img
                    ...
                    class="w-10 h-10 rounded-2xl my-auto"
                    alt=""
                  />
                </div>
              </a>
