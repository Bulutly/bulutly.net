  ...
  export default defineAppConfig({
    config: {
      ...
      footer: {
        ...
        darkLogo: "images/logo-dark.svg",
        hideEmailBox: false,
        emailAPI: "https://api.bulutly.net/api/Email/ContactUs",
        copyRight: `<span>© 2017-2023
                              <a href="https://bulutly.net" class="hover:underline">Bulutly</a>.
                              All Rights Reserved.</span
                            >`,
        partOf: `<p>
          Proudly Part Of
          <a
            href="https://Bulutly.net"
            target="_blank"
            rel="external"
        ...
        socials: [
          {
            ...
            link: "https://twitter.com/bulutlyapp",
          },
  
          {
            icon: "mdi:instagram",
            link: "https://www.instagram.com/bulutlyapp",
          },
          {
            icon: "mdi:linkedin",
            link: "https://www.linkedin.com/company/bulutlyapp",
          },
          {
            icon: "mdi:youtube",
