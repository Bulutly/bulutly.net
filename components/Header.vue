                ...
                <div class="row justify-content-start">
                  <div class="demos-wrapper col-md-6 col-12 py-7 px-8">
                    <h5 class="title">
                      ...
                      <small
                        >sales support, suggest and recommend products in a chat
                        conversation.</small
                      >
                    </h5>
                    <div class="row justify-content-start">
                        ...
                        <a href="index.html" class="demos-box">
                          ...
                          <div class="text">
                            ...
                            <p class="coodiv-text-12 mb-0">
                              Modern, pixel-perfect and perfect solution for
                              WebHosting, reseller hosting and domains provider.
                            </p>
                          </div>
                        </a>
                      </div>
                      ...
                      <div class="col-md-6 col-12">
                        <a href="#" class="demos-box">
                          ...
                          <div class="text">
                            ...
                            <p class="coodiv-text-12 mb-0">
                              For for all web hosting, business, multi purpose,
                              domain sale websites.
                            </p>
                          </div>
                        </a>
                      </div>
                      ...
                      <div class="col-md-6 col-12">
                        <a href="#" class="demos-box">
                          ...
                          <div class="text">
                            ...
                            <p class="coodiv-text-12 mb-0">
                              For online business,vpn & proxy services, vps
                      ...
                      <div class="col-md-6 col-12">
                        <a href="#" class="demos-box">
                          ...
                          <div class="text">
                            ...
                            <p class="coodiv-text-12 mb-0">
                              to all current technology and web regulations to
                              ensure that your web content looks equally
                              stunning
                            </p>
                          </div>
                        </a>
                ...
                <div
                  ...
                  <div class="col-md col-12 bd-highlight">
                    <a class="megamenu-services-box" href="cloud-vps.html">
                      ...
                      <p class="coodiv-text-12">
                        Get 100% worry-free, Fully Managed VPS Hosting with NVMe
                  ...
                  <div class="col-md col-12 bd-highlight">
                    <a class="megamenu-services-box" href="dedicated.html">
                      ...
                      <p class="coodiv-text-12">
                        Trust your site to the world’s #1 web host with 2 TB of
                        space, unlimited bandwidth and free domain.
                      </p>
                    </a>
                  </div>
                ...
                <ul class="web-hosting-menu-header">
                  ...
                  <li>
                    ...
                    <a href="dedicated.html"
                      >Dedicated Hosting
                      <span
                        >Trust your site to the world’s #1 web host, starting at
                        $0.99.</span
                      ></a
                    >
                  </li>
