<template>
  ...
  <section class="contact-us ptb-120 position-relative overflow-hidden">
      ...
      <div class="row justify-content-between">
        <div class="col-xl-5 col-lg-5 col-md-12">
          <div class="section-heading">
            ...
            <p>
              We deliver 24/7 support with Email, Chat, and Phone calling within
              24 hours.
            </p>
          </div>
          <div class="row justify-content-between pb-5">
            <div class="col-sm-6 mb-4 mb-md-0 mb-lg-0">
              ...
              <div class="contact-info">
                ...
                <a
                  href="tel:+447915652775"
                  class="read-more-link text-decoration-none"
                  ><i class="far fa-phone me-2"></i> (44)791-565-2775</a
                >
              </div>
            </div>
            <div class="col-sm-6">
                ...
                <div class="col-sm-6">
                  <div class="input-group mb-3">
                    <select
                      ...
                      <option value="0">None, just getting started</option>
                      <option value="0-20">Less than $20,000</option>
                      <option value="20-50">$20,000 to $50,000</option>
                      <option value="50-100">$50,000 to $100,000</option>
                      <option value="100-500">$100,000 to $500,000</option>
                      <option value="500-10000">More than $500,000</option>
                    </select>
                  </div>
                </div>
                <div class="col-sm-6">
    ...
    <div
      ...
      ">
      <div
        class="bg-circle rounded-circle circle-shape-3 position-absolute bg-dark-light left-5"></div>
      <div
        class="bg-circle rounded-circle circle-shape-1 position-absolute bg-warning right-5"></div>
    </div>
  </section>
  <!--cat subscribe end-->
</template>
