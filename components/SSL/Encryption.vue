<template>
  <section>
    <div class="encryption container-fluid">
      <div class="row justify-content-start mx-md-12 mx-2">
        <div class="col-md-4 plan-ssl-special">
          ...
          <div class="body-ress-v2">
            ...
            <p>
              <s><b>DDOS</b> Protection</s>
            </p>
            <p><a class="ress-install-btn" href="#">install</a></p>
          </div>
        </div>
