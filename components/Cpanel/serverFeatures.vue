<template>
  <section class="server-features bg-default-2 py-25">
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-md-8 col-12 text-center">
          <p style="color: #81a2f8" class="eyebrow content-text-author_eyebrow">
            High Performance Compute Instances Activate in seconds. Online 24x7
          </p>
          <h3 class="coodiv-text-4 font-weight-bold">Server Features</h3>
        </div>
      </div>
